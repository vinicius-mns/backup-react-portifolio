...
const certificados = [
	{
		titulo: 'Fundamentos',
		img: 'https://api.accredible.com/v1/frontend/credential_website_embed_image/certificate/38013201',
		link: 'https://www.credential.net/57368f52-2ce0-4003-b4f4-bae0209a995e#gs.7xplpt'
	},
	{
		titulo: 'Front-End',
		img: 'https://api.accredible.com/v1/frontend/credential_website_embed_image/certificate/42886866',
		link: 'https://www.credential.net/c2a6609d-1c9e-4ff7-88a4-669dfa23fe2d#gs.7xps3x'
	},
	{
		titulo: 'Back-End',
		img: 'https://api.accredible.com/v1/frontend/credential_website_embed_image/certificate/54650665',
		link: 'https://www.credential.net/0ee03b0c-bf3c-432a-b17c-fbbdcce92198#gs.7xps4h'
	},
]
...
const soft = [
	...
	},
	{
		...
		content: [ 'Raciocínio logico e tomada de decisão são meus pontos fortes, questiono sempre que tenho dúvidas e não aceito mediocridade.' ]
	},
	{
		titulo: 'Criatividade',
		content: [ 'Meu portfólio deve dizer alguma coisa. Amo fazer coisas novas, diferentes, ter liberdade criativa, aprender, criar e surpreender pessoas.' ]
	},
	{
		titulo: 'Lideranca',
		content: [ 'Sei liderar e ser liderado, busco sempre gerir bem o meu tempo e me autoliderar.' ]
	},
]
